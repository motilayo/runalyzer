...
def generate_pbx_id():
    # Apple's PBX IDs are usually 24 uppercase hex characters.
    return uuid.uuid4().hex[:24].upper()

def add_file_to_pbxproj(pbxproj_path, file_path, group_name="Models"):
...
add_file_to_pbxproj("Runalyzer.xcodeproj/project.pbxproj", "Runalyzer/Models/FatigueInsight.swift")
add_file_to_pbxproj("Runalyzer.xcodeproj/project.pbxproj", "Runalyzer/Models/RunMetricsDTO.swift")
