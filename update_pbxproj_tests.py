...
def add_file_to_pbxproj(pbxproj_path, file_path, group_name="RunalyzerTests"):
    ...
    # 3. Add to Sources Build Phase for RunalyzerTests target (913E5F14D322A8B0572A3D92)
    source_phase_regex = r'(913E5F14D322A8B0572A3D92 /\* Sources \*/ = \{\n\t\t\tisa = PBXSourcesBuildPhase;\n\t\t\tbuildActionMask = 2147483647;\n\t\t\tfiles = \()'
...
add_file_to_pbxproj("Runalyzer.xcodeproj/project.pbxproj", "RunalyzerTests/MacroQueryEngineTests.swift")
add_file_to_pbxproj("Runalyzer.xcodeproj/project.pbxproj", "RunalyzerTests/FetchDescriptorTests.swift")
