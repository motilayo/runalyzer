...
def add_file_to_pbxproj(pbxproj_path, file_path, group_name="CoachingEngine"):
...
add_file_to_pbxproj("Runalyzer.xcodeproj/project.pbxproj", "Runalyzer/CoachingEngine/MacroQueryEngine.swift")
